"! <p class="shorttext"><strong>Setter Injection</strong><br/>ABAP cheat sheet example class</p>
"!
"! <p>The example class demonstrates setter injection as ABAP Unit test double injection
"! technique.<br/>
...
CLASS zcl_demo_abap_oodp_aunit_settr DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_demo_abap_oodp_aunit_settr IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.

    zcl_demo_abap_oodp_aux=>set_example_divider( out  = out text = `Setter Injection` ).
