...
CLASS zcl_demo_abap_xml_json IMPLEMENTATION.
  ...
  METHOD if_oo_adt_classrun~main.
    ...
    out->write( |\n| ).
    out->write( `Result of the xstring to string conversions:`  ).
    out->write( |\n| ).
...
***********************************************************************
    ...
    out->write( `9) Transforming XML to XML Using XSLT` ).
    out->write( |\n| ).
...
***********************************************************************
    ...
    out->write( zcl_demo_abap_aux=>heading( `10) Transforming ABAP to XML Using XSLT` ) ).
...
***********************************************************************
    ...
    out->write( zcl_demo_abap_aux=>heading( `11) ABAP <-> XML using Simple Transformations (1)` ) ).
...
***********************************************************************
    ...
    out->write( zcl_demo_abap_aux=>heading( `12) ABAP <-> XML using Simple Transformations (2)` ) ).
...
************************************************************************
    ...
    out->write( zcl_demo_abap_aux=>heading( `14) Structures` ) ).
...
************************************************************************
    ...
    out->write( zcl_demo_abap_aux=>heading( `15) Internal tables` ) ).
...
************************************************************************
    ...
    out->write( zcl_demo_abap_aux=>heading( `16) Data References` ) ).
...
************************************************************************
    ...
    out->write( zcl_demo_abap_aux=>heading( `17) Object References` ) ).
...
************************************************************************
    ...
    out->write( zcl_demo_abap_aux=>heading( `22) Excursion: Compressing and Decompressing Binary Data` ) ).
