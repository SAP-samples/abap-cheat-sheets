...
**********************************************************************
    ...
    ASSIGN lcl_demo=>some_data->* TO FIELD-SYMBOL(<a>).
    ...
    ASSIGN  lcl_demo=>some_data->* TO FIELD-SYMBOL(<b>).
    ...
    ASSIGN  lcl_demo=>some_data->* TO FIELD-SYMBOL(<c>).
    output->display( input = <c> name = `<c>` ).

    lcl_demo=>generic_tab( EXPORTING i_anytab = c_tab ).

    ASSIGN  lcl_demo=>some_data->* TO FIELD-SYMBOL(<d>).
    output->display( input = <d> name = `<d>` ).
