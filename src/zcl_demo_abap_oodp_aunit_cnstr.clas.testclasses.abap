...
CLASS ltd_test_data DEFINITION FOR TESTING.
  PUBLIC SECTION.
    INTERFACES zif_demo_abap_get_data PARTIALLY IMPLEMENTED.
ENDCLASS.
...
CLASS zcl_demo_abap_oodp_aunit_cnstr DEFINITION LOCAL FRIENDS ltc_test.

CLASS ltc_test IMPLEMENTATION.
  METHOD test_get_occ_rate.
    DATA ref_data_prov TYPE REF TO zif_demo_abap_get_data.
    ...
    DATA(ref_cut) = NEW zcl_demo_abap_oodp_aunit_cnstr( ref_data_prov ).
