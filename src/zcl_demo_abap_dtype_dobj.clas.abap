...
**********************************************************************
    ...
    LOOP AT tt_conv_tab REFERENCE INTO DATA(wa_ref_con).
      ASSIGN wa_ref_con->to_be_converted->* TO FIELD-SYMBOL(<co>).

      TRY.
          wa_ref_con->conv_c_len2 = <co>.
...
**********************************************************************
    ...
    LOOP AT tab_num REFERENCE INTO DATA(fp_ref).
      TRY.
          ASSIGN fp_ref->num1->* TO FIELD-SYMBOL(<x>).
          ASSIGN fp_ref->num2->* TO FIELD-SYMBOL(<y>).
          fp_ref->result = addition_with_generic_num( num1 = <x> num2 = <y> ).
